...

{
  ...
  "description": "This template is a dedicated Piano Analytics front-to-server hit sender. It allows for a quick and easy setup for an hybrid data collection strategy.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "LABEL",
    "name": "intro",
    "displayName": "This template is used to send data to your server-side GTM container. \u003cbr\u003e\u003cul\u003e\n\u003cli\u003eAccount parameters should be setup in the first part of this tag \u003ci\u003eand is also available in the server tag\u003c/i\u003e.\u003c/li\u003e\n\u003cli\u003eWe recommand that you send the proper event parameters here. \u003ci\u003eIt is also available in the server tag\u003c/i\u003e.\u003c/li\u003e\n\u003c/ul\u003e\u003cbr\u003e"
  },
  {
    "type": "TEXT",
    "name": "endpoint",
    "displayName": "Your sGTM endpoint",
    ...
    "help": "Should not contains \"/\". The path is hardcoded in this tag and the server client."
  },
  {
    "type": "GROUP",
    "name": "baseParams",
    ...
    "subParams": [
      {
        ...
        "displayName": "Site ID",
        "simpleValueType": true,
        "help": "ID of the site the data belongs",
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "Unique identifier of the visitor. GUID recommended.\u003cbr\u003e\u003ci\u003eDefaults to \"pa_vid\" cookie value.\u003c/i\u003e",
      ...
      },
      {
        "type": "TEXT",
        "name": "previous_url",
        "displayName": "Previous page url",
        "simpleValueType": true,
        "alwaysInSummary": false,
        "help": "Previous page url.\u003cbr\u003e\u003ci\u003eDefaults to protocol, host and path\u003c/i\u003e"
      }
    ],
    "help": "See full \u003ca href\u003d\"https://developers.atinternet-solutions.com/piano-analytics-tagging-fr/marquer-des-evenements-piano-analytics-fr/api-de-collecte-fr/\"\u003ePiano Analytics\u003c/a\u003e documentation."
  },
  {
    "type": "GROUP",
    "name": "event",
    ...
    "subParams": [
      {
        ...
        "simpleValueType": true,
        "help": "Piano Analytics standard events : \u003ca href\u003d\"https://developers.atinternet-solutions.com/piano-analytics-tagging-fr/marquer-des-evenements-piano-analytics-fr/evenements-standards-delta-fr/\"\u003elink\u003c/a\u003e",
      ...
      },
      {
        "type": "CHECKBOX",
        "name": "Ecommerce",
        "checkboxText": "Automatically concatenate Google Analytics Data",
        "simpleValueType": true,
        "help": "Transform UA \u0026 GA4 ecommerce events :\u003cbr\u003e\n\u003cul\u003e\u003cli\u003eclick / select_item\u003c/li\u003e\u003cli\u003edetail / view_item\u003c/li\u003e\u003cli\u003eadd / add_to_cart\u003c/li\u003e\u003c/ul\u003e\nto Piano specific parameters : \u003cbr\u003e \u003cul\u003e\u003cli\u003eproduct_id\u003c/li\u003e\u003cli\u003eproduct\u003c/li\u003e\u003cli\u003eproduct_category1\u003c/li\u003e\u003cli\u003eproduct_brand\u003c/li\u003e\u003cli\u003eproduct_pricetaxincluded\u003c/li\u003e\u003cli\u003e\u003ci\u003eproduct_quantity if existing\u003c/i\u003e\u003c/li\u003e\u003c/ul\u003e"
      }
    ]
  },
  {
        ...
        "simpleTableColumns": [
          {
            ...
            "selectItems": [
              ...
              {
                "value": "sr",
                "displayValue": "Screen resolution (widthxheight)"
              },
              {
                "value": "dir",
                "displayValue": "Display resolution (widthxheight)"
              },
              {
                "value": "ip",
              ...
              {
                "value": "df",
                "displayValue": "Device Manufacturer"
              }
            ],
            "isUnique": true
          },
