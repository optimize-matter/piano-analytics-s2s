...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Piano Analytics S2S - Transporteur",
  "brand": {
    "id": "brand_dummy",
  ...
  "description": "Ce tag est utilisé comme transporteur spécialisé pour Piano Analytics. Il permet de facilement construire une stratégie de collecte de données hybride en collectant le minimum standard requis par Piano Analytics.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "LABEL",
    "name": "intro",
    "displayName": "Ce template sert à envoyer les évènements Piano Analytics vers votre Google Tag Manager Server side. \u003cbr\u003e\u003cul\u003e\n\u003cli\u003eLa première partie de paramétrage des informations peut se faire dans ce tag, \u003ci\u003eou dans le tag server side\u003c/i\u003e.\u003c/li\u003e\n\u003cli\u003eNous recommandons d\u0027effectuer le paramétrage de l\u0027évènement dans ce tag. \u003ci\u003eIl est également possible de le paramétrer dans le server side\u003c/i\u003e.\u003c/li\u003e\n\u003c/ul\u003e\u003cbr\u003e"
  },
  {
    "type": "TEXT",
    "name": "endpoint",
    "displayName": "Endpoint de votre container sGTM",
    "simpleValueType": true,
    "valueHint": "sgtm.website.com",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      },
    ...
    "help": "Ne doit pas contenir de \"/\". Le chemin de destination est géré par ce tag et le client dans sGTM."
  },
  {
    "type": "GROUP",
    "name": "baseParams",
    ...
    "subParams": [
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "Identifiant unique du visiteur. GUID recommandé.\u003cbr\u003e\u003ci\u003ePar défaut, prend la valeur du cookie \"pa_vid\".\u003c/i\u003e",
      ...
      },
      {
        "type": "TEXT",
        "name": "previous_url",
        "displayName": "URL précédente.",
        "simpleValueType": true,
        "alwaysInSummary": false,
        "help": "URL de la page précédente.\u003cbr\u003e\u003ci\u003ePar défaut, récupère uniquement le protocole, l\u0027hôte et le chemin\u003c/i\u003e"
      }
    ],
  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        "type": "SIMPLE_TABLE",
        "name": "eventData",
        "displayName": "Données de l\u0027évènement",
        "simpleTableColumns": [
          {
            "defaultValue": "",
      ...
      },
      {
        "type": "CHECKBOX",
        "name": "Ecommerce",
        "checkboxText": "Concaténer des données ecommerce Google Analytics",
        "simpleValueType": true,
        "help": "Transforme les données UA \u0026 GA4 des évènements :\u003cbr\u003e\n\u003cul\u003e\u003cli\u003eclick / select_item\u003c/li\u003e\u003cli\u003edetail / view_item\u003c/li\u003e\u003cli\u003eadd / add_to_cart\u003c/li\u003e\u003c/ul\u003e\nEn variables adaptés pour Piano : \u003cbr\u003e \u003cul\u003e\u003cli\u003eproduct_id\u003c/li\u003e\u003cli\u003eproduct\u003c/li\u003e\u003cli\u003eproduct_category1\u003c/li\u003e\u003cli\u003eproduct_brand\u003c/li\u003e\u003cli\u003eproduct_pricetaxincluded\u003c/li\u003e\u003cli\u003e\u003ci\u003eproduct_quantity si incluse\u003c/i\u003e\u003c/li\u003e\u003c/ul\u003e"
      }
    ]
  },
  {
    ...
    "subParams": [
      {
        ...
        "simpleTableColumns": [
          {
            ...
            "selectItems": [
              ...
              {
                "value": "sr",
                "displayValue": "Résolution d\u0027écran (widthxheight)"
              },
              {
                "value": "dir",
                "displayValue": "Résolution de l\u0027affichage (widthxheight)"
              },
              {
                "value": "ip",
                "displayValue": "Adresse IP"
              },
              {
                "value": "dm",
                "displayValue": "Modèle de l’appareil"
              },
              {
                "value": "df",
                "displayValue": "Fabricant de l’appareil"
              }
            ],
            "isUnique": true
          },
        ...
        "newRowButtonText": "Ajouter un paramètre"
      }
    ]
  }
]
...
const log = require('logToConsole'),
      ...
      getTimestampMillis = require('getTimestampMillis'), ts = getTimestampMillis(),
      ...
      makeTableMap = require('makeTableMap'),
      copyFromDataLayer = require('copyFromDataLayer'),
      success = msg => {log(msg); data.gtmOnSuccess();},
      fail = msg => {log(msg); data.gtmOnFailure();},
      format_data = obj => {
        let getRequest = "",o,m; o=Object.entries(obj);o.forEach(
          function(element){
            if(element[1] == undefined) return getRequest+="";
            else return getRequest+=element[0]+"="+element[1]+"&";
          }
        );
...
/* Authorized APIs */
// Window readers
const getRURL = require('getReferrerUrl'), referrerURL = getRURL("protocol")+"://"+getRURL("host")+getRURL("path"),
      getURL = require('getUrl'), URL = getURL("protocol")+"://"+getURL("host")+getURL("path"),
      readTitle = require('readTitle'), title = readTitle(),
      readCharacterSet = require('readCharacterSet'), encoding = readCharacterSet();

// Cookie reader
const getCookieValues = require('getCookieValues'),
      atuserid =  getCookieValues("atuserid", true),
      pauserid = getCookieValues("pa_vid", true)[0].slice(1,-1),
      atauthority = getCookieValues("atauthority",true) || null,
      privacyConsent = getCookieValues("pa_privacy",true) ? true : false,
      privacyMode = getCookieValues("pa_privacy",true)[0].slice(1,-1);

// Pixel sender
const sendPixel = require('sendPixel'),
      endpoint = data.endpoint,
      target = "https://"+endpoint+"/pa?";

/* Variables */
// Base Params
const site_id = data.site_id,
      visitor_id = data.visitor_id || pauserid || atuserid,
      previous_url = data.previous_url || referrerURL;

// Event data
const eventName = data.eventName,
      eventData = data.eventData,
      eventDataMapper = makeTableMap(eventData, "prop", "val");

let eventObj = {"name" : eventName,
                "data" : {}},
    eventArray = [];
...
// Logic
if(!!eventData && !!eventName){Object.keys(eventDataMapper).forEach((element) => {eventObj.data[element] = eventDataMapper[element];});}

log(eventObj);

// Ecommerce
if(data.Ecommerce && ((copyFromDataLayer('items',1) && copyFromDataLayer('items',1).length == 1) || copyFromDataLayer('ecommerce', 1))){
  const ecom = copyFromDataLayer('items',1) || copyFromDataLayer('ecommerce',1);
  const mapper = {
    "price": "product_pricetaxincluded",
    "quantity": "product_quantity",
    "item_brand": "product_brand",
    "item_category": "product_category1",
    "item_id": "product_id",
    "item_name": "product",
    "brand": "product_brand",
  ...
  const prods = ecom.items || Object.values(ecom)[0].products;
  Object.keys(prods[0]).forEach((element) => {
    if(mapper[element] != undefined) eventObj.data[mapper[element]] = prods[0][element];
  });
}
...
// Pixel sender
eventArray.push(JSON.stringify(eventObj));
let getData = {
  "dl" : URL,
  "dr" : previous_url,
  "dt" : title.replace("&",""),
...
if(data.moreParamsTable != undefined && !data.moreParamsTable.param && !data.moreParamsTable.value) {
  let arr = data.moreParamsTable;
  arr.forEach((key) => getData[key.param] = key.value);
}

getData = encodeUri(format_data(getData));
log(getData);
const pixel = sendPixel(target+getData, success('Event sent to '+target+' - OK', getData), data.gtmOnSuccess);
pixel();
...
Created on 20/06/2022, 11:40:21
